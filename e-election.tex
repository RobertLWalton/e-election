...
connected to each other by a local network but which are not
...
spans elections and that is updated by addition and subtraction
...
that takes as input the Registration, Election, M-Box, and Collection
Information Drives.
