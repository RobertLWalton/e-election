...
When a PVM makes are request of a Registration Machine for
...
Thus if a PVM is duplicated and one copy votes and receives certificates
from a quorum of Registration Machines,
the other copy will be notified when it attempts to access the
Registration Machines, and will not be able to change the vote.
Of course,
...
votes, the E-Election System make it even harder for vote purchases
