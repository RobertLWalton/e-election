...
An big advantage to the scammer is that negatives are hard to prove
...
during checkin and checkout.  The replacement may be challenged
...
prompt arrest, as there is a policeman on site at the polling
place.
...
It appears that no such scheme has been realized as of
the current time.  However, were such as scheme realized,
some selling voters would surely be found out and prosecuted,
driving up the price of a vote up to unsustainable levels.
...
sold vote counted.  So the VMB cannot pay the vote seller
