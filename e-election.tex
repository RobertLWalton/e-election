...
To prevend overloading the memory used to hold the locked boxes,
Registration Machines and Collection Machines need to limit the
number of requests they recieve from a particular Private Voting Machine.
...
ISPs will be above to collect meta-data that will allow them to
make good guesses as to with IP addresses were used to cast votes.
However, better information of this kind is made publically available
...
\subsection{Election Preparation}
