...
that takes as input the Registration, M-Box, and Collection
Information Drives.

Note that Registration Machines never communicate with each other
or with Collection Machines, except via the Collection Information
Drive input when a Registration Machine is made.

Note that Collection Machines never communicate with each other
before the end of the election
except when making the Collection Information Drive.
